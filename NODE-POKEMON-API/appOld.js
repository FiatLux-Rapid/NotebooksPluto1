...
const { success, getUniqueId } = require('./helper.js')  // getID, success
...
let pokemons = require('./src/db/mock-pokemon')  // initial pokemons data base
const {Sequelize,DataTypes} = require('sequelize')  // SQL /JS interconnexion
const PokemonModel= require('./src/models/pokemon') // pkempon js model
const app = express()
const port = 3000
